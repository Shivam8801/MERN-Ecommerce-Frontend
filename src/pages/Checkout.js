        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
                <div className="lg:col-span-3">
                    ...
                    <form className='bg-white px-5 mt-12 py-16'>
                        <div className="border-b border-gray-900/10 pb-12">
                            <h2 className="text-4xl font-bold tracking-tight text-gray-900">Personal Information</h2>
                        ...
                        <div className="border-b border-gray-900/10 pb-12 mt-5">
                            ...
                            <ul role="list">
                                {addresses.map((address) => (
                                    <li key={address.email} className="flex justify-between gap-x-6 px-5 py-5 mt-5 border-solid border-2 border-gray-200">
                                        <div className="flex gap-x-4">
                                            ...
                                            <div className="min-w-0 flex-auto">
                                                ...
                                                <p className="mt-1 truncate text-xs leading-5 text-gray-500">{address.state}&#44; {address.pincode}</p>
                                            </div>
                                        </div>
